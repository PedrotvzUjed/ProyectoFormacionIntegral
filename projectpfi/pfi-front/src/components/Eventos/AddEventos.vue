<template>
  <v-container>
    <v-card elevation="8" style="max-with: 500px">
      <v-card-title>
        Registro de evento
      </v-card-title>

      <v-container style="padding: 0px 45px 45px 45px;" v-if="!submitted">
        <v-row>
          <v-col>
